...
class TendonsStudiesResource(object):
    def on_get(self, req, resp):
        ...
        resp_json = [
            ...
            for (
            uuid, name, arrayExpressId, pubMedId, description, geneExpressionType, platform, organism, cellOrigin, year,
            sampleSize) in results
        ]
    ...
    def on_post(self, req, resp):
        ...
        study_type = determineStudyType(study['geneExpressionType'])
        ...
        try:
            ...
            with db_conn.cursor() as cur:
                ...
                cur.execute(
                    """
                    INSERT INTO tendons_metadata (uuid, name, arrayExpressId, pubMedId, description, geneExpressionType, platform, organism, cellOrigin, year, sampleSize)
