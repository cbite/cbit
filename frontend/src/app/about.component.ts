    ...
    <div class="container">
      <div class="row justified">
        <div class="col-xs-8 col-xs-offset-2">
          ...
          <p>cBiT is a repository that incorporates material science and transcriptomics-based cell biology, with a focus on clinically relevant materials. It is based on the principle of “materiomics”, which offers a holistic approach to material systems that aims to merge materials science and biological methodologies in order to open new opportunities to discover novel and improved materials with reduced development times. cBiT contains a collection of genome-wide transcriptional expression data (microarray and RNAseq) from relevant cell lines cultured on clinically successful and promising biomaterials. Where available, these transcriptomics data are accompanied by an in depth material property characterization of the associated biomaterials.</p> 
          
          <h2>A new tool</h2>
          We present the cBiT repository as a new tool to help scientists generate and collect unique and standardized knowledge on how different cell types interact with a wide range of commonly used biomaterials. By generating new information and simultaneously accumulating it in an open access repository, we expect it is possible to one day predict cell response to biomaterials. Such a prediction approach towards biomaterial development will drastically reduce the current time and development costs, while at the same time ensuring higher clinical success rates. 
          
          <img src="/public/images/cbit-overview.png" class="img-overview"> 
          
          
          <h2>Data organization and tutorial</h2>
          <p>cBiT can be easily queried and studies or samples of interest can be selected and subsequently downloaded. All the available data are organized using ISA-TAB archives which ensure a standardized way of characterizing samples and an unambiguous identification of samples. For a tutorial on how to use cBiT, please have a look at the following video:</p>
          
          
          <div class="centered">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/Zvvaz1qJW0s" frameborder="0" allowfullscreen></iframe>
          </div>
          
          <h2>More information</h2>
          <p>More details on how cBiT was designed and the principles of materiomics can also be found in the following papers:</p>
          <ul>
          ...
          Researchers who are interested in depositing their own data in cBiT can contact us for detailed instructions and support on how to prepare the data into archives. Please send an email to Dennie Hebels (d.hebels [at] maastrichtuniversity.nl). 
          
          <h3>Contact</h3>
          <pre>
          Maastricht University
          MERLN Institute
          Department of Cell-Biology Inspired Tissue Engineering (cBITE)
          Universiteitssingel 40
          6229 ER Maastricht
          The Netherlands
          </pre>
          
          <p>Questions regarding the use of cBiT or other details on how cBiT is set up, can be directed to Dennie Hebels (d.hebels [at] maastrichtuniversity.nl).</p>
          
          <h2>Licensing information</h2> 
          <p>The use of cBiT is free of charge for academic users. Commercial users should contact Prof. Jan de Boer (jan.deboer [at] maastrichtuniversity.nl).</p> 
          
          <p>If you would like written approval for a specific use that is otherwise prohibited, please contact Dr. Dennie Hebels (d.hebels [at] maastrichtuniversity.nl).</p>
          
          <h2>Disclaimer</h2>
          <p>The information, services or products provided on cBiT may contain errors and may be subject to temporary interruption. Although we do our best to provide all information, services and products as complete and accurate as possible, we cannot be held responsible for any errors, defects or other harmful consequences, deriving from the use of cBiT. Therefore we renounce any liability whatsoever, within the boundaries of Dutch law.</p>
          ...
          <p>&copy; 2016 Laboratory for cell-Biology inspired Tissue Engineering, Maastricht University. All Rights Reserved.</p>
        </div>
      </div>
    </div>
  `,
